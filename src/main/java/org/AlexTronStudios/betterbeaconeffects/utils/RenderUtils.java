...
public class RenderUtils {
    ...
    public static void renderFace(Matrix4f matrix4f, VertexConsumer vertexConsumer, float startX, float endX, float startY, float endY, float p_228884_8_, float p_228884_9_, float p_228884_10_, float p_228884_11_, float r, float g, float b, float a, int u1, int v1, int u2, int v2) {
        vertexConsumer.addVertex(matrix4f, startX, startY, p_228884_8_).setColor(r, g, b, a).setUv(u1,v1).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(1,1).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, endX, startY, p_228884_9_).setColor(r, g, b, a).setUv(u2,v1).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(1,1).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, endX, endY, p_228884_10_).setColor(r, g, b, a).setUv(u2,v2).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(1,1).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, startX, endY, p_228884_11_).setColor(r, g, b, a).setUv(u1,v2).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(1,1).setNormal(0,1,0);
    }

    public static void renderFace(Matrix4f matrix4f, VertexConsumer vertexConsumer, float startX, float endX, float startY, float endY, float p_228884_8_, float p_228884_9_, float p_228884_10_, float p_228884_11_, float r, float g, float b, float a, float u1, float v1, float u2, float v2) {
        vertexConsumer.addVertex(matrix4f, startX, startY, p_228884_8_).setColor(r, g, b, a).setUv(u1,v1).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, endX, startY, p_228884_9_).setColor(r, g, b, a).setUv(u2,v1).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, endX, endY, p_228884_10_).setColor(r, g, b, a).setUv(u2,v2).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0,1,0);
        vertexConsumer.addVertex(matrix4f, startX, endY, p_228884_11_).setColor(r, g, b, a).setUv(u1,v2).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0,1,0);
    }
